  ...
  static const List<Map<String, dynamic>> pages = [
    {
      ...
      'content': [
        ...
        '• Projekt-Assessment: Auswertungder hochgeladenen Dokumente',
        '• Wissensbasis: Übersicht über extrahierte Informationen aus deinen Dokumenten',
        '• Beispiel-Fragen: Zeigt beispielhafte Fragen und Antworten, die der Chatbot beantworten kann.',
    ...
    },
    {
      ...
      'content': [
        ...
        '• Wenn dein PDF Grafiken oder Diagramme enthält, gib beim Upload die entsprechenden Seitenzahlen an.',
    ...
    },
    {
      ...
      'content': [
        ...
        '• Jedes mal wenn du eine neue Datei hochlädst, werden neue Fragen generiert.',
